...
8. On the left you should see a list of files generated to aid the migration of the app to Liberty running in IBM Cloud Pak for Applications on Private Cloud . On the right click the link **View the steps ->**
